          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-6 space-y-6" id="dashboard_vales_gerenciais">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-8 space-y-4">
                {/* Labeled Modern Filters Bar matching user image layout */}
                <div className="bg-white border border-slate-200/60 rounded-xl p-4 shadow-3xs flex flex-col sm:flex-row items-stretch sm:items-end gap-4">
                  {/* Colaborador / Busca */}
                  <div className="flex-1 flex flex-col gap-1">
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block">COLABORADOR</span>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-slate-200 rounded-lg py-2 pl-9 pr-3 text-xs font-semibold text-slate-800 focus:outline-none focus:ring-1 focus:ring-slate-400 h-9"
                      />
                    </div>
                  </div>

                  {/* Status */}
                  <div className="sm:min-w-[200px] flex flex-col gap-1">
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block">STATUS DA META</span>
                    <div className="relative">
                      <select
                        value={valesFilter}
                        onChange={(e) => setValesFilter(e.target.value as any)}
                        className="w-full bg-white border border-slate-200 rounded-lg py-2 pl-3 pr-8 text-xs font-semibold text-slate-800 focus:outline-none focus:ring-1 focus:ring-slate-400 h-9 appearance-none cursor-pointer"
                      >
                        <option value="todos">Todos</option>
                        <option value="PENDENTE_ASSINATURA">Pendente</option>
          ...
          <div className="lg:col-span-9 bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            {cadastroSubTab === 'produtos' && (
              <div className="space-y-6">
                ...
                {/* Table of Products */}
                <div className="border border-slate-100 rounded-lg overflow-auto max-h-96">
                  <table className="min-w-full divide-y divide-slate-100 text-left text-xs">
                  ...
                  return (
                    <div className="space-y-6">
                      ...
                      <div className="bg-white p-5 rounded-xl border border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        {/* Modern styled filter matching the user image */}
                        <div className="bg-white border border-slate-200/60 rounded-xl p-3 shadow-3xs flex items-center gap-4">
                          <div className="flex flex-col gap-1 min-w-[180px]">
                            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block">PERÍODO (CALENDÁRIO)</span>
                            <div className="relative flex items-center">
                              ...
                              <select
                                ...
                                className="w-full bg-white border border-slate-200 rounded-lg py-2 pl-9 pr-8 text-xs font-semibold text-blue-900 focus:outline-none focus:ring-1 focus:ring-slate-400 h-9 appearance-none cursor-pointer"
                              >
      ...
      {gestorTab === 'historico' && (
        <div className="space-y-8 animate-fade-in" id="gestor_historico_tab">
          ...
          {historicoSubTab === 'auditorias' ? (
            ...
            <h3 className="font-sans font-bold text-xs text-amber-600 uppercase tracking-widest mb-4">
              ...
              return (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 text-center">
                    <span className="text-[10px] text-slate-500 font-mono uppercase block">Total de Baixas</span>
                    <span className="text-2xl font-bold text-slate-950 block mt-1">{totalMaps} mapas</span>
                  </div>

                  <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-200 text-center">
                    <span className="text-[10px] text-emerald-700 font-mono uppercase block">Status 100% OK</span>
                    <span className="text-2xl font-bold text-emerald-600 block mt-1">{okMaps} mapas</span>
                  </div>

                  <div className="bg-red-50 p-4 rounded-xl border border-red-200 text-center">
                    <span className="text-[10px] text-red-700 font-mono uppercase block">Divergências</span>
                    <span className="text-2xl font-bold text-red-600 block mt-1">{divMaps} mapas</span>
                  </div>

                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 text-center">
                    <span className="text-[10px] text-slate-500 font-mono uppercase block">Volume do Desvio</span>
                    <span className="text-lg font-bold text-slate-800 block mt-1">Faltas: {missingQtyTotal} | Sobras: {surplusQtyTotal}</span>
                  </div>
                </div>
              );
            })()}
          ...
          <div className="bg-white rounded-xl shadow-xs border border-slate-200 p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex flex-col gap-1">
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block">BUSCAR MAPA / MOTORISTA</span>
                <div className="relative">
                  <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
                  <input
                    type="text"
              ...
              {/* De */}
              <div className="flex flex-col gap-1">
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block">PERÍODO (INÍCIO)</span>
                <div className="relative">
                  <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-blue-600" />
                  <input
                    type="date"
                    ...
                    className="w-full bg-white border border-slate-200 rounded-lg py-2 pl-9 pr-3 text-xs font-semibold text-blue-900 focus:outline-none focus:ring-1 focus:ring-slate-400 h-9"
                  />
                </div>
              </div>
              ...
              {/* Até */}
              <div className="flex flex-col gap-1">
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block">PERÍODO (FIM)</span>
                <div className="relative">
                  <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-blue-600" />
                  <input
                    type="date"
              ...
              {/* Status */}
              <div className="flex flex-col gap-1">
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block">STATUS DA CONCILIAÇÃO</span>
                <div className="relative">
                  <select
                    value={historyStatusFilter}
                    onChange={e => setHistoryStatusFilter(e.target.value as any)}
                    className="w-full bg-white border border-slate-200 rounded-lg py-2 pl-3 pr-8 text-xs font-semibold text-blue-900 focus:outline-none focus:ring-1 focus:ring-slate-400 h-9 appearance-none cursor-pointer"
                  >
