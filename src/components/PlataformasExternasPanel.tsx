...
const DEFAULT_PLATFORMS: ExternalPlatformTool[] = [
  ...
  },
  {
    ...
    name: 'Trocas e Reposições (Armazém)',
    category: 'Garantia & Gestão de Avarias',
    url: 'https://djeanderson1105-code.github.io/ARMAZ-M-/',
    description: 'Ferramenta de gestão para registros de trocas de produtos, reposições imediatas de estoque e fluxo operacional de Armazém.',
    instructions: '1. Acesse o portal oficial de Trocas e Reposições.\n2. Lance as trocas físicas, comerciais e reposições de rota.\n3. Acompanhe a resolução das ordens e destinação para Repack/Despejo.',
    status: 'active',
    lastUpdatedBy: 'Sistema Oficial',
    lastUpdatedAt: new Date().toLocaleDateString('pt-BR'),
    openMode: 'new_tab',
  ...
  {
    id: 'pacote-prejuizo',
    name: 'Pacote Prejuízo',
    category: 'Controle de Perdas & DPO',
    url: 'https://nhpa-cyber.github.io/Pacote-/',
    description: 'Painel e ferramentas integradas para monitoramento, análise de causas-raiz e redução de prejuízos operacionais e avarias.',
    instructions: '1. Acesse o portal oficial do Pacote Prejuízo.\n2. Verifique os lançamentos de quebras, despejos e divergências.\n3. Acompanhe os planos de ação para atingir o farol verde DPO.',
    status: 'active',
    lastUpdatedBy: 'Sistema Oficial',
    lastUpdatedAt: new Date().toLocaleDateString('pt-BR'),
    openMode: 'new_tab',
  ...
  },
  {
    ...
    category: 'Auditoria & Transferência',
    url: 'https://sofrimento001-sudo.github.io/Blitz/',
    description: 'Ferramenta operacional para auditoria de carretas de transferência, amarração de carga e conformidade DPO.',
    instructions: '1. Acesse a ferramenta oficial da Blitz de Puxada.\n2. Registre a inspeção de amarração, integridade dos paletes e lacres.\n3. Acompanhe o tempo de descarga e liberação das carretas.',
    status: 'active',
    lastUpdatedBy: 'Sistema Oficial',
    lastUpdatedAt: new Date().toLocaleDateString('pt-BR'),
    openMode: 'new_tab',
