...
export const CollaboratorActivitiesDrilldownModal: React.FC<CollaboratorActivitiesDrilldownModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/60 dark:bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-3 sm:p-5 overflow-y-auto animate-fadeIn">
      <div className="bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-700/80 rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden text-slate-800 dark:text-slate-100">
        
        {/* MODAL HEADER */}
        <div className="p-5 bg-slate-50 dark:bg-gradient-to-r dark:from-[#111a30] dark:to-[#1e293b] border-b border-slate-200 dark:border-slate-700 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3.5">
            <div className="w-12 h-12 rounded-xl bg-indigo-100 dark:bg-indigo-600/20 border border-indigo-200 dark:border-indigo-500/40 flex items-center justify-center text-indigo-700 dark:text-indigo-400 font-black text-xl shadow-inner">
              {nome.charAt(0)}
            </div>
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Turno: <strong className="text-slate-800 dark:text-slate-200">{turno}</strong> • Auditoria Completa de Atividades Realizadas (Meta vs Real)
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 p-4 bg-slate-100/70 dark:bg-[#0a0f1d] border-b border-slate-200 dark:border-slate-800 shrink-0">
          ...
          <div className="bg-white dark:bg-[#131d33] border border-indigo-200 dark:border-indigo-500/30 rounded-xl p-3 shadow-2xs">
            ...
            <div className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold mt-0.5 flex items-center gap-1">
              ...
              <strong className={percentualMeta >= 100 ? 'text-emerald-600 dark:text-emerald-400' : 'text-amber-600 dark:text-amber-400'}>
          ...
          <div className="bg-white dark:bg-[#131d33] border border-slate-200 dark:border-slate-800 rounded-xl p-3 shadow-2xs">
            ...
            <div className="mt-1">
              <span className={`inline-block px-2 py-0.5 rounded-lg text-xs font-black uppercase ${
                statusMeta === 'Acima da Meta' ? 'bg-emerald-50 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-500/40' :
                statusMeta === 'Dentro da Meta' ? 'bg-indigo-50 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-500/40' :
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 dark:bg-[#111a30] border border-slate-200 dark:border-slate-800 rounded-2xl p-4 space-y-3">
                  <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-2">
                    <h4 className="text-xs font-black uppercase tracking-wider text-indigo-600 dark:text-indigo-400 flex items-center gap-2">
                      <Box className="w-4 h-4 text-indigo-600 dark:text-indigo-400" /> Performance de Repack
                    </h4>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white dark:bg-[#0b1222] p-3 rounded-xl border border-slate-200 dark:border-slate-800/80">
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase block">Ritmo Operacional</span>
                      <div className="flex items-baseline gap-1.5 mt-1">
                        <strong className="text-lg font-mono text-slate-900 dark:text-white">{repack.ritmoRealCxH}</strong>
                        <span className="text-xs font-mono text-indigo-600 dark:text-indigo-400">/ Meta: {repack.ritmoMetaCxH} cx/h</span>
                      </div>
                      <span className={`text-[10px] font-black uppercase mt-1 block ${
                        repack.ritmoRealCxH >= repack.ritmoMetaCxH ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'
                      }`}>
                    ...
                    <div className="bg-white dark:bg-[#0b1222] p-3 rounded-xl border border-slate-200 dark:border-slate-800/80">
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase block">Meta por Embalagem</span>
                      <div className="flex items-baseline gap-1.5 mt-1">
                        <strong className="text-lg font-mono text-emerald-600 dark:text-emerald-400">{repack.tempoRealMin}m</strong>
                        <span className="text-xs font-mono text-slate-500 dark:text-slate-400">/ Padrão: {repack.tempoMetaMin}m</span>
                      </div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold mt-1 block">
                        Eficiência: <strong className="text-slate-900 dark:text-white">{repack.eficienciaPct}%</strong>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 dark:bg-[#111a30] border border-slate-200 dark:border-slate-800 rounded-2xl p-4 space-y-3">
                  <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-2">
                    <h4 className="text-xs font-black uppercase tracking-wider text-indigo-600 dark:text-indigo-400 flex items-center gap-2">
                      <Trash2 className="w-4 h-4 text-indigo-600 dark:text-indigo-400" /> Performance de Despejo
                    </h4>
                    <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400">
                      Meta: 3.0 min/cx
                    </span>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white dark:bg-[#0b1222] p-3 rounded-xl border border-slate-200 dark:border-slate-800/80">
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase block">Volume Processado</span>
                      <div className="flex items-baseline gap-1.5 mt-1">
                        <strong className="text-lg font-mono text-slate-900 dark:text-white">{despejo.totalItens}</strong>
                    ...
                    <div className="bg-white dark:bg-[#0b1222] p-3 rounded-xl border border-slate-200 dark:border-slate-800/80">
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase block">Tempo Real vs Meta</span>
                      <div className="flex items-baseline gap-1.5 mt-1">
                        <strong className="text-lg font-mono text-emerald-600 dark:text-emerald-400">{despejo.tempoRealMin}m</strong>
                        <span className="text-xs font-mono text-slate-500 dark:text-slate-400">/ Meta: {despejo.tempoMetaMin}m</span>
                      </div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold mt-1 block">
                        Eficiência: <strong className="text-slate-900 dark:text-white">{despejo.eficienciaPct}%</strong>
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <table className="w-full text-left text-xs bg-white dark:bg-[#0b1222]">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800/50">
                      ...
                      <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30">
                        ...
                        <td className="p-2.5 text-slate-700 dark:text-slate-300">Tempo Padrão de Reembalagem das Caixas</td>
                        <td className="p-2.5 text-center font-mono font-bold text-slate-500 dark:text-slate-400">{repack.tempoMetaMin} min</td>
                        <td className="p-2.5 text-center font-mono font-black text-emerald-600 dark:text-emerald-400">{repack.tempoRealMin} min</td>
                        <td className="p-2.5 text-center">
                          <span className="px-2 py-0.5 rounded text-[10px] font-black uppercase bg-emerald-50 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/30">
                      ...
                      <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30">
                        ...
                        <td className="p-2.5 text-slate-700 dark:text-slate-300">Descarte e Despejo de Vasilhames</td>
                        <td className="p-2.5 text-center font-mono font-bold text-slate-500 dark:text-slate-400">{despejo.tempoMetaMin} min</td>
                        <td className="p-2.5 text-center font-mono font-black text-emerald-600 dark:text-emerald-400">{despejo.tempoRealMin} min</td>
                        <td className="p-2.5 text-center">
                          <span className="px-2 py-0.5 rounded text-[10px] font-black uppercase bg-emerald-50 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/30">
          ...
          {activeTab === 'repack' && (
            <div className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div className="bg-slate-50 dark:bg-[#111a30] p-4 rounded-xl border border-slate-200 dark:border-slate-800">
                  <span className="text-[10px] font-black uppercase text-slate-500 dark:text-slate-400">Meta 1: Ritmo (10 cx/h)</span>
                ...
                <div className="bg-slate-50 dark:bg-[#111a30] p-4 rounded-xl border border-slate-200 dark:border-slate-800">
                  <span className="text-[10px] font-black uppercase text-slate-500 dark:text-slate-400">Meta 2: Tempo por Embalagem</span>
                  <p className="text-2xl font-mono font-black text-emerald-600 dark:text-emerald-400 mt-1">{repack.tempoRealMin} min</p>
                  <span className="text-[10px] text-slate-500 dark:text-slate-400">Meta padrão somada: {repack.tempoMetaMin} min</span>
                </div>
              </div>

              {repack.atividades.length === 0 ? (
                <div className="p-8 text-center bg-slate-50 dark:bg-[#111a30] rounded-xl border border-dashed border-slate-300 dark:border-slate-800 text-slate-500 dark:text-slate-400 text-xs">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                      {repack.atividades.map((item, idx) => (
                        <tr key={item.id || idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                          ...
                          <td className="p-3 text-center font-mono font-bold text-indigo-600 dark:text-indigo-300">{item.quantidade} cx</td>
                          <td className="p-3 text-center text-slate-500 dark:text-slate-400 font-mono">{item.inicio} - {item.fim}</td>
                          <td className="p-3 text-center font-mono font-bold text-emerald-600 dark:text-emerald-400">{item.duracaoRealMin} min</td>
                          <td className="p-3 text-center font-mono text-slate-500 dark:text-slate-400">{item.duracaoMetaMin} min</td>
                          <td className="p-3 text-center font-mono font-black text-amber-600 dark:text-amber-400">{item.ritmoRealCxH} cx/h</td>
                          <td className="p-3 text-center">
                            <span className={`px-2 py-0.5 rounded text-[10px] font-black uppercase ${
                              item.status === 'DENTRO DA META' ? 'bg-emerald-50 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/30' : 'bg-rose-50 dark:bg-rose-500/20 text-rose-700 dark:text-rose-400 border border-rose-200 dark:border-rose-500/30'
                            }`}>
                              {item.status}
                            </span>
                          </td>
                  ...
                  <table className="w-full text-left text-xs">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                      {despejo.atividades.map((item, idx) => (
                        <tr key={item.id || idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                          <td className="p-3 font-mono text-slate-700 dark:text-slate-300">{item.data}</td>
                          <td className="p-3 font-bold text-slate-900 dark:text-white">{item.tipoVasilhame}</td>
                          <td className="p-3 text-center font-mono font-bold text-indigo-600 dark:text-indigo-300">{item.quantidade}</td>
              ...
              {jornadas.length === 0 ? (
                ...
                <div className="overflow-x-auto bg-white dark:bg-[#111a30] rounded-xl border border-slate-200 dark:border-slate-800">
                  <table className="w-full text-left text-xs">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                      {jornadas.map((j, idx) => (
                        <tr key={j.id || idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
