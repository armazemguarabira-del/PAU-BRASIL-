...
export const DEFAULT_RESPONSAVEIS_5S: AreaResponsavel5S[] = [
  ...
  { id: '7', area: 'RECICLÁVEIS', responsavel: 'ADELSON SANTOS DE ARAUJO', cargoResponsavel: 'MOTORISTA', observacao: 'Central de Recicláveis', metaPct: 80 },
  { id: '8', area: 'REFUGO', responsavel: 'GLADSON LISBOA DOS SANTOS', cargoResponsavel: 'AJUDANTE', observacao: 'Gestão de Refugos (Campeão Maio)', metaPct: 80 },
  { id: '9', area: 'DEVOLUÇÃO', responsavel: 'GLADSON LISBOA DOS SANTOS', cargoResponsavel: 'AJUDANTE', observacao: 'Conferência de Devolução (Campeão Maio)', metaPct: 80 },
