    ...
    switch (dashboard) {
      ...
      case 'despejo':
        return {
          ...
          dataCriacaoISO: todayStr,
          problemaDesc: 'O tempo de despejo de líquidos vencidos/retornados está acima do padrão VPO (meta de 50 segundos por embalagem), gerando acúmulo de paletes na área de descarte e elevando a taxa de desperdício/quebras operacionais.',
          ...
          problemaEvidencias: 'Mapeamento diário de despejos mostrando média de 1:15 min por embalagem e taxa de quebras e perdas de garrafas atingindo 1.8% do volume de retorno total.',
          ...
          resultadosDesc: 'O tempo de despejo foi reduzido significativamente e estabilizado abaixo da meta de 50 segundos por embalagem.',
